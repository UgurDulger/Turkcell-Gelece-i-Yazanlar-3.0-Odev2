...
public class CTBKPSPublicSoap
{
    ...
    public CTBKPSPublicSoap(){}

    public CTBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CTBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CTBExtendedSoapSerializationEnvelope envelope= new CTBExtendedSoapSerializationEnvelope(CTBExtendedSoapSerializationEnvelope.VER11);
