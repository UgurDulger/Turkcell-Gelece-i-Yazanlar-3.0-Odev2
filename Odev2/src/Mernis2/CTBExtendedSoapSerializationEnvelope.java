...
class CTBSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class CTBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CTBDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new CTBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CTBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CTBDateTimeConverter dateTimeConverter = new CTBStandardDateTimeConverter();

    public CTBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CTBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CTBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CTBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CTBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CTBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
